const { DeliveryOptionV2 } = require("../../models/v2");
...
exports.getDeliveryOptions = async (req, res) => {
  try {
    ...
    const deliveryOptions = await DeliveryOptionV2.find(query)
...
exports.getDeliveryOptionById = async (req, res) => {
  try {
    ...
    const deliveryOption = await DeliveryOptionV2.findById(id);
...
exports.getAvailableDeliveryOptions = async (req, res) => {
  try {
    ...
    let deliveryOptions = await DeliveryOptionV2.find(query)
      .sort({ cost: 1, estimatedDays: 1 });
...
exports.createDeliveryOption = async (req, res) => {
  try {
    ...
    const deliveryOption = new DeliveryOptionV2({
      name,
...
exports.deleteDeliveryOption = async (req, res) => {
  try {
    ...
    await DeliveryOptionV2.findByIdAndDelete(id);
